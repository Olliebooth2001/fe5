  ...
  return (
    ...
    <div className='text-white bg-gradient-to-t from-gray-700 via-black to-black' id='hero'>
      <div className='max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
        <p className='text-[#00A370] font-bold p-2'>USING OCR TO ANALYSE BANK STATEMENTS</p>
        ...
        <button id ='scrollToUploadBtn'className="bg-[#00A370] hover:bg-[#004731] text-white font-bold py-2 px-4 rounded-full w-40">
