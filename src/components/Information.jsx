      ...
      <div className='w-full bg-white py-16 px-4 z-10' id='info'>
          <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
              ...
              <div className='flex flex-col justify-center'>
                  ...
                  <p className='text-[#00A370] font-bold flex items-center text-3xl pb-5'>HOW THE APPLICATION WORKS&nbsp; <AiOutlineInfoCircle size={30}/> </p>
                    <div className=''>
                  <p className='pb-5'>
                    <strong className='text-[#00A370]'>1.</strong>  &nbsp; Bank statement is uploaded and is sent to be processed by Azure Form Recognizer.
                  </p>
                  <p className='pb-5'>
                    <strong className='text-[#00A370]'>2.</strong>  &nbsp; Azure Form Recogniser then applies a form of advanced machine learning known as Optical Character Recognition to process your bank statement and extract values. This works by training a model with a number of bank statements and labeling fields which are required such as Money In and Money Out.
                  </p>
                  <p className='pb-5'>
